...
//    }
    ...
    func createWaveFormSegmentViews() {
        setupOscSegmentView(44.5, y: 208.3, width: 145, height: 45.0, tag: ControlTag.Vco1Waveform.rawValue, type: 3)
        setupOscSegmentView(44.5, y: 416.0, width: 145, height: 45.0, tag: ControlTag.Vco2Waveform.rawValue, type: 1)
...
//        }
        ...
        segmentView.selectSegmentAtIndex(type)
