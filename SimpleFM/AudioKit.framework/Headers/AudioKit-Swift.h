...
+ (int32_t)queueCount;
+ (void)setQueueCount:(int32_t)value;

/// AKAudioFile Delegate
@property (nonatomic, strong) id <AKAudioFileDelegate> _Nullable delegate;
...
/// Super.init inherited from AVAudioFile superclass
///
/// <ul><li>Parameters:</li><li>fileURL: NSURL of the file.</li><li>format: The processing commonFormat to use when reading from the file.</li><li>interleaved: Bool (Whether to use an interleaved processing format.)</li></ul>
/// \param error NSError if init failed .
///
/// \returns  An initialized AKAudioFile object for reading, or nil if init failed.
...
/// Super.init inherited from AVAudioFile superclass
///
/// <ul><li>Parameters:</li><li>fileURL: NSURL of the file.</li><li>settings: The format of the file to create.</li><li>format: The processing commonFormat to use when writing.</li><li>interleaved: Bool (Whether to use an interleaved processing format.)</li></ul>
...
///
/// <ul><li>Parameters:</li><li>avAudioFile: an AVAudioFile.</li></ul>
/// \param error NSError if init failed .
///
/// \returns  An initialized AKAudioFile for reading, or nil if init failed.
- (nullable instancetype)initWithReadAVAudioFile:(AVAudioFile * _Nonnull)avAudioFile error:(NSError * _Nullable * _Null_unspecified)error;
...
///
/// \returns  An initialized AKAudioFile for writing, or nil if init failed.
- (nullable instancetype)initWithWriteAVAudioFile:(AVAudioFile * _Nonnull)avAudioFile error:(NSError * _Nullable * _Null_unspecified)error;
@end
...
SWIFT_PROTOCOL("_TtP8AudioKit19AKAudioFileDelegate_")
@protocol AKAudioFileDelegate
@optional

/// Presents the processed AKAudioFile
///
/// \param audioFile the processed AKAudioFile
- (void)didFinishProcessing:(AKAudioFile * _Nullable)audioFile;
@end
...
- (BOOL)loadAKAudioFile:(AKAudioFile * _Nonnull)file error:(NSError * _Nullable * _Null_unspecified)error;
...
/// Output Amplitude.
///
/// <ul><li>Range: -90.0 -> +12 db</li><li>Default: 0 db</li></ul>
@property (nonatomic) double amplitude;

/// Normalized Output Volume.
///
/// <ul><li>Range:   0 - 1</li><li>Default: 1</li></ul>
@property (nonatomic) double volume;

/// Pan.
///
/// <ul><li>Range:   -1 - 1</li><li>Default: 0</li></ul>
@property (nonatomic) double pan;
...
/// Stop a MIDI Note
///
/// <ul><li>noteNumber: MIDI Note Number to stop</li><li>channel: MIDI Channnel</li></ul>
- (void)stopWithNoteNumber:(NSInteger)noteNumber channel:(NSInteger)channel;
@end
...
@interface AKPWMOscillator : AKVoice
...
///
/// \param detuningMultiplier Frequency detuning multiplier
- (nonnull instancetype)initWithPulseWidth:(double)pulseWidth attackDuration:(double)attackDuration releaseDuration:(double)releaseDuration detuningOffset:(double)detuningOffset detuningMultiplier:(double)detuningMultiplier OBJC_DESIGNATED_INITIALIZER;
...
///
/// \param velocity MIDI Velocity (0-127)
- (void)playWithVoice:(AKVoice * _Nonnull)voice noteNumber:(NSInteger)noteNumber velocity:(NSInteger)velocity;
...
///
/// \param noteNumber MIDI Note Number
- (void)stopWithVoice:(AKVoice * _Nonnull)voice noteNumber:(NSInteger)noteNumber;
